...
export type LiftSearchQueryVariables = Exact<{
  id: Scalars['String']['input'];
}>;


export type LiftSearchQuery = { __typename?: 'Query', search: Array<(
    { __typename?: 'Lift' }
    & { ' $fragmentRefs'?: { 'LiftList_LiftFragment': LiftList_LiftFragment } }
  ) | { __typename?: 'Trail' }> };
